const CACHE_NAME = 'graviton-cache-v254';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=254',
  './assets/js/main.js?v=254',
  './assets/js/ui.js?v=254',
  './assets/js/db.js?v=254',
  './assets/js/utils.js?v=254',
  './assets/js/supabase-client.js?v=254',
