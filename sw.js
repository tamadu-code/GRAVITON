const CACHE_NAME = 'graviton-cache-v334';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=334',
  './assets/js/main.js?v=334',
  './assets/js/ui.js?v=334',
  './assets/js/db.js?v=334',
  './assets/js/utils.js?v=334',
  './assets/js/supabase-client.js?v=334',
