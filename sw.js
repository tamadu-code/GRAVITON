const CACHE_NAME = 'graviton-cache-v253';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=253',
  './assets/js/main.js?v=253',
  './assets/js/ui.js?v=253',
  './assets/js/db.js?v=253',
  './assets/js/utils.js?v=253',
  './assets/js/supabase-client.js?v=253',
