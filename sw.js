const CACHE_NAME = 'graviton-cache-v264';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=264',
  './assets/js/main.js?v=264',
  './assets/js/ui.js?v=264',
  './assets/js/db.js?v=264',
  './assets/js/utils.js?v=264',
  './assets/js/supabase-client.js?v=264',
