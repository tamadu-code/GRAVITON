const CACHE_NAME = 'graviton-cache-v345';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=345',
  './assets/js/main.js?v=345',
  './assets/js/ui.js?v=345',
  './assets/js/db.js?v=345',
  './assets/js/utils.js?v=345',
  './assets/js/supabase-client.js?v=345',
