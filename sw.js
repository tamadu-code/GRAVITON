const CACHE_NAME = 'graviton-cache-v343';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=343',
  './assets/js/main.js?v=343',
  './assets/js/ui.js?v=343',
  './assets/js/db.js?v=343',
  './assets/js/utils.js?v=343',
  './assets/js/supabase-client.js?v=343',
