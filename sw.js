const CACHE_NAME = 'graviton-cache-v296';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=296',
  './assets/js/main.js?v=296',
  './assets/js/ui.js?v=296',
  './assets/js/db.js?v=296',
  './assets/js/utils.js?v=296',
  './assets/js/supabase-client.js?v=296',
