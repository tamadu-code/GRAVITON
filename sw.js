const CACHE_NAME = 'graviton-cache-v362';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=362',
  './assets/js/main.js?v=362',
  './assets/js/ui.js?v=362',
  './assets/js/db.js?v=362',
  './assets/js/utils.js?v=362',
  './assets/js/supabase-client.js?v=362',
