const CACHE_NAME = 'graviton-cache-v182';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=182',
  './assets/js/main.js?v=182',
  './assets/js/ui.js?v=182',
  './assets/js/db.js?v=182',
  './assets/js/utils.js?v=182',
  './assets/js/supabase-client.js?v=182',
