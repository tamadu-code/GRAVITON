const CACHE_NAME = 'graviton-cache-v305';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=305',
  './assets/js/main.js?v=305',
  './assets/js/ui.js?v=305',
  './assets/js/db.js?v=305',
  './assets/js/utils.js?v=305',
  './assets/js/supabase-client.js?v=305',
