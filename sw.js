const CACHE_NAME = 'graviton-cache-v183';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=183',
  './assets/js/main.js?v=183',
  './assets/js/ui.js?v=183',
  './assets/js/db.js?v=183',
  './assets/js/utils.js?v=183',
  './assets/js/supabase-client.js?v=183',
