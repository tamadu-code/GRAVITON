const CACHE_NAME = 'graviton-cache-v284';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=284',
  './assets/js/main.js?v=284',
  './assets/js/ui.js?v=284',
  './assets/js/db.js?v=284',
  './assets/js/utils.js?v=284',
  './assets/js/supabase-client.js?v=284',
