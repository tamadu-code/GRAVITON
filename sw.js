const CACHE_NAME = 'graviton-cache-v311';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=311',
  './assets/js/main.js?v=311',
  './assets/js/ui.js?v=311',
  './assets/js/db.js?v=311',
  './assets/js/utils.js?v=311',
  './assets/js/supabase-client.js?v=311',
