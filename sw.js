const CACHE_NAME = 'graviton-cache-v333';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=333',
  './assets/js/main.js?v=333',
  './assets/js/ui.js?v=333',
  './assets/js/db.js?v=333',
  './assets/js/utils.js?v=333',
  './assets/js/supabase-client.js?v=333',
