const CACHE_NAME = 'graviton-cache-v251';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=251',
  './assets/js/main.js?v=251',
  './assets/js/ui.js?v=251',
  './assets/js/db.js?v=251',
  './assets/js/utils.js?v=251',
  './assets/js/supabase-client.js?v=251',
