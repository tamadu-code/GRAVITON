const CACHE_NAME = 'graviton-cache-v247';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=247',
  './assets/js/main.js?v=247',
  './assets/js/ui.js?v=247',
  './assets/js/db.js?v=247',
  './assets/js/utils.js?v=247',
  './assets/js/supabase-client.js?v=247',
