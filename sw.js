const CACHE_NAME = 'graviton-cache-v303';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=303',
  './assets/js/main.js?v=303',
  './assets/js/ui.js?v=303',
  './assets/js/db.js?v=303',
  './assets/js/utils.js?v=303',
  './assets/js/supabase-client.js?v=303',
