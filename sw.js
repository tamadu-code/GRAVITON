const CACHE_NAME = 'graviton-cache-v297';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=297',
  './assets/js/main.js?v=297',
  './assets/js/ui.js?v=297',
  './assets/js/db.js?v=297',
  './assets/js/utils.js?v=297',
  './assets/js/supabase-client.js?v=297',
