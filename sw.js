const CACHE_NAME = 'graviton-cache-v341';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=341',
  './assets/js/main.js?v=341',
  './assets/js/ui.js?v=341',
  './assets/js/db.js?v=341',
  './assets/js/utils.js?v=341',
  './assets/js/supabase-client.js?v=341',
