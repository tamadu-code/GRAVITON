const CACHE_NAME = 'graviton-cache-v312';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=312',
  './assets/js/main.js?v=312',
  './assets/js/ui.js?v=312',
  './assets/js/db.js?v=312',
  './assets/js/utils.js?v=312',
  './assets/js/supabase-client.js?v=312',
