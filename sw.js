const CACHE_NAME = 'graviton-cache-v350';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=350',
  './assets/js/main.js?v=350',
  './assets/js/ui.js?v=350',
  './assets/js/db.js?v=350',
  './assets/js/utils.js?v=350',
  './assets/js/supabase-client.js?v=350',
