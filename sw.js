const CACHE_NAME = 'graviton-cache-v170';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=170',
  './assets/js/main.js?v=170',
  './assets/js/ui.js?v=170',
  './assets/js/db.js?v=170',
  './assets/js/utils.js?v=170',
  './assets/js/supabase-client.js?v=170',
