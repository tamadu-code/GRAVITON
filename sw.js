const CACHE_NAME = 'graviton-cache-v232';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=232',
  './assets/js/main.js?v=232',
  './assets/js/ui.js?v=232',
  './assets/js/db.js?v=232',
  './assets/js/utils.js?v=232',
  './assets/js/supabase-client.js?v=232',
