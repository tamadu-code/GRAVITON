const CACHE_NAME = 'graviton-cache-v231';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=231',
  './assets/js/main.js?v=231',
  './assets/js/ui.js?v=231',
  './assets/js/db.js?v=231',
  './assets/js/utils.js?v=231',
  './assets/js/supabase-client.js?v=231',
