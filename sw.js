const CACHE_NAME = 'graviton-cache-v315';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=315',
  './assets/js/main.js?v=315',
  './assets/js/ui.js?v=315',
  './assets/js/db.js?v=315',
  './assets/js/utils.js?v=315',
  './assets/js/supabase-client.js?v=315',
