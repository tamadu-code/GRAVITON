const CACHE_NAME = 'graviton-cache-v249';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=249',
  './assets/js/main.js?v=249',
  './assets/js/ui.js?v=249',
  './assets/js/db.js?v=249',
  './assets/js/utils.js?v=249',
  './assets/js/supabase-client.js?v=249',
