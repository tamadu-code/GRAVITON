const CACHE_NAME = 'graviton-cache-v233';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=233',
  './assets/js/main.js?v=233',
  './assets/js/ui.js?v=233',
  './assets/js/db.js?v=233',
  './assets/js/utils.js?v=233',
  './assets/js/supabase-client.js?v=233',
