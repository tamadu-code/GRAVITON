const CACHE_NAME = 'graviton-cache-v161';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=161',
  './assets/js/main.js?v=161',
  './assets/js/ui.js?v=161',
  './assets/js/db.js?v=161',
  './assets/js/utils.js?v=161',
  './assets/js/supabase-client.js?v=161',
