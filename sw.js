const CACHE_NAME = 'graviton-cache-v294';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=294',
  './assets/js/main.js?v=294',
  './assets/js/ui.js?v=294',
  './assets/js/db.js?v=294',
  './assets/js/utils.js?v=294',
  './assets/js/supabase-client.js?v=294',
