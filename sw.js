const CACHE_NAME = 'graviton-cache-v248';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=248',
  './assets/js/main.js?v=248',
  './assets/js/ui.js?v=248',
  './assets/js/db.js?v=248',
  './assets/js/utils.js?v=248',
  './assets/js/supabase-client.js?v=248',
