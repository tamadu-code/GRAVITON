const CACHE_NAME = 'graviton-cache-v268';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=268',
  './assets/js/main.js?v=268',
  './assets/js/ui.js?v=268',
  './assets/js/db.js?v=268',
  './assets/js/utils.js?v=268',
  './assets/js/supabase-client.js?v=268',
