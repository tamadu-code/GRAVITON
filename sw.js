const CACHE_NAME = 'graviton-cache-v394';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=394',
  './assets/js/main.js?v=394',
  './assets/js/ui.js?v=394',
  './assets/js/db.js?v=394',
  './assets/js/utils.js?v=394',
  './assets/js/supabase-client.js?v=394',
  './assets/js/aiDetector.js?v=394',
