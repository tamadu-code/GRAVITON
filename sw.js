const CACHE_NAME = 'graviton-cache-v370';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=370',
  './assets/js/main.js?v=370',
  './assets/js/ui.js?v=370',
  './assets/js/db.js?v=370',
  './assets/js/utils.js?v=370',
  './assets/js/supabase-client.js?v=370',
