const CACHE_NAME = 'graviton-cache-v241';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=239',
  './assets/js/main.js?v=239',
  './assets/js/ui.js?v=239',
  './assets/js/db.js?v=239',
  './assets/js/utils.js?v=239',
  './assets/js/supabase-client.js?v=239',
