const CACHE_NAME = 'graviton-cache-v342';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=342',
  './assets/js/main.js?v=342',
  './assets/js/ui.js?v=342',
  './assets/js/db.js?v=342',
  './assets/js/utils.js?v=342',
  './assets/js/supabase-client.js?v=342',
