const CACHE_NAME = 'graviton-cache-v393';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=393',
  './assets/js/main.js?v=393',
  './assets/js/ui.js?v=393',
  './assets/js/db.js?v=393',
  './assets/js/utils.js?v=393',
  './assets/js/supabase-client.js?v=393',
  './assets/js/aiDetector.js?v=393',
