const CACHE_NAME = 'graviton-cache-v336';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=336',
  './assets/js/main.js?v=336',
  './assets/js/ui.js?v=336',
  './assets/js/db.js?v=336',
  './assets/js/utils.js?v=336',
  './assets/js/supabase-client.js?v=336',
