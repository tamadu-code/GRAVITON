const CACHE_NAME = 'graviton-cache-v252';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=252',
  './assets/js/main.js?v=252',
  './assets/js/ui.js?v=252',
  './assets/js/db.js?v=252',
  './assets/js/utils.js?v=252',
  './assets/js/supabase-client.js?v=252',
