const CACHE_NAME = 'graviton-cache-v228';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=228',
  './assets/js/main.js?v=228',
  './assets/js/ui.js?v=228',
  './assets/js/db.js?v=228',
  './assets/js/utils.js?v=228',
  './assets/js/supabase-client.js?v=228',
