const CACHE_NAME = 'graviton-cache-v277';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=277',
  './assets/js/main.js?v=277',
  './assets/js/ui.js?v=277',
  './assets/js/db.js?v=277',
  './assets/js/utils.js?v=277',
  './assets/js/supabase-client.js?v=277',
