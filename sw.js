const CACHE_NAME = 'graviton-cache-v390';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=390',
  './assets/js/main.js?v=390',
  './assets/js/ui.js?v=390',
  './assets/js/db.js?v=390',
  './assets/js/utils.js?v=390',
  './assets/js/supabase-client.js?v=390',
  './assets/js/aiDetector.js?v=390',
