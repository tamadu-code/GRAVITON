const CACHE_NAME = 'graviton-cache-v236';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=236',
  './assets/js/main.js?v=236',
  './assets/js/ui.js?v=236',
  './assets/js/db.js?v=236',
  './assets/js/utils.js?v=236',
  './assets/js/supabase-client.js?v=236',
