const CACHE_NAME = 'graviton-cache-v310';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=310',
  './assets/js/main.js?v=310',
  './assets/js/ui.js?v=310',
  './assets/js/db.js?v=310',
  './assets/js/utils.js?v=310',
  './assets/js/supabase-client.js?v=310',
