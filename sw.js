const CACHE_NAME = 'graviton-cache-v352';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=351',
  './assets/js/main.js?v=351',
  './assets/js/ui.js?v=351',
  './assets/js/db.js?v=351',
  './assets/js/utils.js?v=351',
  './assets/js/supabase-client.js?v=351',
