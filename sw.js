const CACHE_NAME = 'graviton-cache-v162';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=162',
  './assets/js/main.js?v=162',
  './assets/js/ui.js?v=162',
  './assets/js/db.js?v=162',
  './assets/js/utils.js?v=162',
  './assets/js/supabase-client.js?v=162',
