const CACHE_NAME = 'graviton-cache-v272';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=272',
  './assets/js/main.js?v=272',
  './assets/js/ui.js?v=272',
  './assets/js/db.js?v=272',
  './assets/js/utils.js?v=272',
  './assets/js/supabase-client.js?v=272',
