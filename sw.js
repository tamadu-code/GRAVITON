const CACHE_NAME = 'graviton-cache-v384';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=384',
  './assets/js/main.js?v=384',
  './assets/js/ui.js?v=384',
  './assets/js/db.js?v=384',
  './assets/js/utils.js?v=384',
  './assets/js/supabase-client.js?v=384',
  './assets/js/aiDetector.js?v=384',
