const CACHE_NAME = 'graviton-cache-v355';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=355',
  './assets/js/main.js?v=355',
  './assets/js/ui.js?v=355',
  './assets/js/db.js?v=355',
  './assets/js/utils.js?v=355',
  './assets/js/supabase-client.js?v=355',
