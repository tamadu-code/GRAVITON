const CACHE_NAME = 'graviton-cache-v237';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=237',
  './assets/js/main.js?v=237',
  './assets/js/ui.js?v=237',
  './assets/js/db.js?v=237',
  './assets/js/utils.js?v=237',
  './assets/js/supabase-client.js?v=237',
