const CACHE_NAME = 'graviton-cache-v263';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=263',
  './assets/js/main.js?v=263',
  './assets/js/ui.js?v=263',
  './assets/js/db.js?v=263',
  './assets/js/utils.js?v=263',
  './assets/js/supabase-client.js?v=263',
