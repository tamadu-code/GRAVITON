const CACHE_NAME = 'graviton-cache-v238';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=238',
  './assets/js/main.js?v=238',
  './assets/js/ui.js?v=238',
  './assets/js/db.js?v=238',
  './assets/js/utils.js?v=238',
  './assets/js/supabase-client.js?v=238',
