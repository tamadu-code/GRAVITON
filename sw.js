const CACHE_NAME = 'graviton-cache-v361';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=361',
  './assets/js/main.js?v=361',
  './assets/js/ui.js?v=361',
  './assets/js/db.js?v=361',
  './assets/js/utils.js?v=361',
  './assets/js/supabase-client.js?v=361',
