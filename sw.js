const CACHE_NAME = 'graviton-cache-v389';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=389',
  './assets/js/main.js?v=389',
  './assets/js/ui.js?v=389',
  './assets/js/db.js?v=389',
  './assets/js/utils.js?v=389',
  './assets/js/supabase-client.js?v=389',
  './assets/js/aiDetector.js?v=389',
