const CACHE_NAME = 'graviton-cache-v340';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=340',
  './assets/js/main.js?v=340',
  './assets/js/ui.js?v=340',
  './assets/js/db.js?v=340',
  './assets/js/utils.js?v=340',
  './assets/js/supabase-client.js?v=340',
