const CACHE_NAME = 'graviton-cache-v262';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=262',
  './assets/js/main.js?v=262',
  './assets/js/ui.js?v=262',
  './assets/js/db.js?v=262',
  './assets/js/utils.js?v=262',
  './assets/js/supabase-client.js?v=262',
