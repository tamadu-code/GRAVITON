const CACHE_NAME = 'graviton-cache-v225';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=225',
  './assets/js/main.js?v=225',
  './assets/js/ui.js?v=225',
  './assets/js/db.js?v=225',
  './assets/js/utils.js?v=225',
  './assets/js/supabase-client.js?v=225',
