const CACHE_NAME = 'graviton-cache-v256';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=256',
  './assets/js/main.js?v=256',
  './assets/js/ui.js?v=256',
  './assets/js/db.js?v=256',
  './assets/js/utils.js?v=256',
  './assets/js/supabase-client.js?v=256',
