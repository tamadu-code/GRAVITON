const CACHE_NAME = 'graviton-cache-v391';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=391',
  './assets/js/main.js?v=391',
  './assets/js/ui.js?v=391',
  './assets/js/db.js?v=391',
  './assets/js/utils.js?v=391',
  './assets/js/supabase-client.js?v=391',
  './assets/js/aiDetector.js?v=391',
