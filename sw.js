const CACHE_NAME = 'graviton-cache-v223';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=223',
  './assets/js/main.js?v=223',
  './assets/js/ui.js?v=223',
  './assets/js/db.js?v=223',
  './assets/js/utils.js?v=223',
  './assets/js/supabase-client.js?v=223',
