const CACHE_NAME = 'graviton-cache-v265';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=265',
  './assets/js/main.js?v=265',
  './assets/js/ui.js?v=265',
  './assets/js/db.js?v=265',
  './assets/js/utils.js?v=265',
  './assets/js/supabase-client.js?v=265',
