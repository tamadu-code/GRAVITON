const CACHE_NAME = 'graviton-cache-v366';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=366',
  './assets/js/main.js?v=366',
  './assets/js/ui.js?v=366',
  './assets/js/db.js?v=366',
  './assets/js/utils.js?v=366',
  './assets/js/supabase-client.js?v=366',
