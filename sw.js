const CACHE_NAME = 'graviton-cache-v392';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=392',
  './assets/js/main.js?v=392',
  './assets/js/ui.js?v=392',
  './assets/js/db.js?v=392',
  './assets/js/utils.js?v=392',
  './assets/js/supabase-client.js?v=392',
  './assets/js/aiDetector.js?v=392',
