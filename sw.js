const CACHE_NAME = 'graviton-cache-v363';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=363',
  './assets/js/main.js?v=363',
  './assets/js/ui.js?v=363',
  './assets/js/db.js?v=363',
  './assets/js/utils.js?v=363',
  './assets/js/supabase-client.js?v=363',
