const CACHE_NAME = 'graviton-cache-v295';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=295',
  './assets/js/main.js?v=295',
  './assets/js/ui.js?v=295',
  './assets/js/db.js?v=295',
  './assets/js/utils.js?v=295',
  './assets/js/supabase-client.js?v=295',
