const CACHE_NAME = 'graviton-cache-v168';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=168',
  './assets/js/main.js?v=168',
  './assets/js/ui.js?v=168',
  './assets/js/db.js?v=168',
  './assets/js/utils.js?v=168',
  './assets/js/supabase-client.js?v=168',
