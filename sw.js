const CACHE_NAME = 'graviton-cache-v364';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=364',
  './assets/js/main.js?v=364',
  './assets/js/ui.js?v=364',
  './assets/js/db.js?v=364',
  './assets/js/utils.js?v=364',
  './assets/js/supabase-client.js?v=364',
