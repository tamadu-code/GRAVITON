const CACHE_NAME = 'graviton-cache-v224';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=224',
  './assets/js/main.js?v=224',
  './assets/js/ui.js?v=224',
  './assets/js/db.js?v=224',
  './assets/js/utils.js?v=224',
  './assets/js/supabase-client.js?v=224',
