const CACHE_NAME = 'graviton-cache-v360';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=360',
  './assets/js/main.js?v=360',
  './assets/js/ui.js?v=360',
  './assets/js/db.js?v=360',
  './assets/js/utils.js?v=360',
  './assets/js/supabase-client.js?v=360',
