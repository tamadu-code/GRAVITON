const CACHE_NAME = 'graviton-cache-v246';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=246',
  './assets/js/main.js?v=246',
  './assets/js/ui.js?v=246',
  './assets/js/db.js?v=246',
  './assets/js/utils.js?v=246',
  './assets/js/supabase-client.js?v=246',
