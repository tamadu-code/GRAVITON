const CACHE_NAME = 'graviton-cache-v304';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=304',
  './assets/js/main.js?v=304',
  './assets/js/ui.js?v=304',
  './assets/js/db.js?v=304',
  './assets/js/utils.js?v=304',
  './assets/js/supabase-client.js?v=304',
