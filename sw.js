const CACHE_NAME = 'graviton-cache-v344';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=344',
  './assets/js/main.js?v=344',
  './assets/js/ui.js?v=344',
  './assets/js/db.js?v=344',
  './assets/js/utils.js?v=344',
  './assets/js/supabase-client.js?v=344',
