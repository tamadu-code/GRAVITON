const CACHE_NAME = 'graviton-cache-v298';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=298',
  './assets/js/main.js?v=298',
  './assets/js/ui.js?v=298',
  './assets/js/db.js?v=298',
  './assets/js/utils.js?v=298',
  './assets/js/supabase-client.js?v=298',
