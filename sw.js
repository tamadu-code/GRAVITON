const CACHE_NAME = 'graviton-cache-v235';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=235',
  './assets/js/main.js?v=235',
  './assets/js/ui.js?v=235',
  './assets/js/db.js?v=235',
  './assets/js/utils.js?v=235',
  './assets/js/supabase-client.js?v=235',
