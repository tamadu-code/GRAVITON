const CACHE_NAME = 'graviton-cache-v281';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=281',
  './assets/js/main.js?v=281',
  './assets/js/ui.js?v=281',
  './assets/js/db.js?v=281',
  './assets/js/utils.js?v=281',
  './assets/js/supabase-client.js?v=281',
