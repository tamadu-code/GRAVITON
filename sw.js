const CACHE_NAME = 'graviton-cache-v335';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=335',
  './assets/js/main.js?v=335',
  './assets/js/ui.js?v=335',
  './assets/js/db.js?v=335',
  './assets/js/utils.js?v=335',
  './assets/js/supabase-client.js?v=335',
