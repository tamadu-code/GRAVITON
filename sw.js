const CACHE_NAME = 'graviton-cache-v365';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=365',
  './assets/js/main.js?v=365',
  './assets/js/ui.js?v=365',
  './assets/js/db.js?v=365',
  './assets/js/utils.js?v=365',
  './assets/js/supabase-client.js?v=365',
