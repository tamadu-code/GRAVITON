const CACHE_NAME = 'graviton-cache-v318';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=318',
  './assets/js/main.js?v=318',
  './assets/js/ui.js?v=318',
  './assets/js/db.js?v=318',
  './assets/js/utils.js?v=318',
  './assets/js/supabase-client.js?v=318',
