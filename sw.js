const CACHE_NAME = 'graviton-cache-v320';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=319',
  './assets/js/main.js?v=319',
  './assets/js/ui.js?v=319',
  './assets/js/db.js?v=319',
  './assets/js/utils.js?v=319',
  './assets/js/supabase-client.js?v=319',
