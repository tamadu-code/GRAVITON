const CACHE_NAME = 'graviton-cache-v371';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=371',
  './assets/js/main.js?v=371',
  './assets/js/ui.js?v=371',
  './assets/js/db.js?v=371',
  './assets/js/utils.js?v=371',
  './assets/js/supabase-client.js?v=371',
