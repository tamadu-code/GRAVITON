const CACHE_NAME = 'graviton-cache-v282';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=282',
  './assets/js/main.js?v=282',
  './assets/js/ui.js?v=282',
  './assets/js/db.js?v=282',
  './assets/js/utils.js?v=282',
  './assets/js/supabase-client.js?v=282',
