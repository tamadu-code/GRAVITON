const CACHE_NAME = 'graviton-cache-v346';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=346',
  './assets/js/main.js?v=346',
  './assets/js/ui.js?v=346',
  './assets/js/db.js?v=346',
  './assets/js/utils.js?v=346',
  './assets/js/supabase-client.js?v=346',
