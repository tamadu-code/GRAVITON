const CACHE_NAME = 'graviton-cache-v255';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=255',
  './assets/js/main.js?v=255',
  './assets/js/ui.js?v=255',
  './assets/js/db.js?v=255',
  './assets/js/utils.js?v=255',
  './assets/js/supabase-client.js?v=255',
