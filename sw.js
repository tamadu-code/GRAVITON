const CACHE_NAME = 'graviton-cache-v234';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=234',
  './assets/js/main.js?v=234',
  './assets/js/ui.js?v=234',
  './assets/js/db.js?v=234',
  './assets/js/utils.js?v=234',
  './assets/js/supabase-client.js?v=234',
