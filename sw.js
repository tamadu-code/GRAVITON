const CACHE_NAME = 'graviton-cache-v250';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=250',
  './assets/js/main.js?v=250',
  './assets/js/ui.js?v=250',
  './assets/js/db.js?v=250',
  './assets/js/utils.js?v=250',
  './assets/js/supabase-client.js?v=250',
