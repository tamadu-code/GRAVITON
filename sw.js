const CACHE_NAME = 'graviton-cache-v167';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=167',
  './assets/js/main.js?v=167',
  './assets/js/ui.js?v=167',
  './assets/js/db.js?v=167',
  './assets/js/utils.js?v=167',
  './assets/js/supabase-client.js?v=167',
