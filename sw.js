...
const ASSETS_TO_CACHE = [
  ...
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=396',
  './assets/js/main.js?v=396',
  './assets/js/ui.js?v=396',
  './assets/js/db.js?v=396',
  './assets/js/utils.js?v=396',
  './assets/js/supabase-client.js?v=396',
  './assets/js/aiDetector.js?v=396',
