const CACHE_NAME = 'graviton-cache-v302';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=302',
  './assets/js/main.js?v=302',
  './assets/js/ui.js?v=302',
  './assets/js/db.js?v=302',
  './assets/js/utils.js?v=302',
  './assets/js/supabase-client.js?v=302',
