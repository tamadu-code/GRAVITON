const CACHE_NAME = 'graviton-cache-v356';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=356',
  './assets/js/main.js?v=356',
  './assets/js/ui.js?v=356',
  './assets/js/db.js?v=356',
  './assets/js/utils.js?v=356',
  './assets/js/supabase-client.js?v=356',
