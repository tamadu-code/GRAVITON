const CACHE_NAME = 'graviton-cache-v383';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=383',
  './assets/js/main.js?v=383',
  './assets/js/ui.js?v=383',
  './assets/js/db.js?v=383',
  './assets/js/utils.js?v=383',
  './assets/js/supabase-client.js?v=383',
  './assets/js/aiDetector.js?v=383',
