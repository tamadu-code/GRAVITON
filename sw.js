const CACHE_NAME = 'graviton-cache-v299';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=299',
  './assets/js/main.js?v=299',
  './assets/js/ui.js?v=299',
  './assets/js/db.js?v=299',
  './assets/js/utils.js?v=299',
  './assets/js/supabase-client.js?v=299',
