const CACHE_NAME = 'graviton-cache-v229';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=229',
  './assets/js/main.js?v=229',
  './assets/js/ui.js?v=229',
  './assets/js/db.js?v=229',
  './assets/js/utils.js?v=229',
  './assets/js/supabase-client.js?v=229',
