const CACHE_NAME = 'graviton-cache-v273';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=273',
  './assets/js/main.js?v=273',
  './assets/js/ui.js?v=273',
  './assets/js/db.js?v=273',
  './assets/js/utils.js?v=273',
  './assets/js/supabase-client.js?v=273',
