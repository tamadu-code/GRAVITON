const CACHE_NAME = 'graviton-cache-v165';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=165',
  './assets/js/main.js?v=165',
  './assets/js/ui.js?v=165',
  './assets/js/db.js?v=165',
  './assets/js/utils.js?v=165',
  './assets/js/supabase-client.js?v=165',
