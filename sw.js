const CACHE_NAME = 'graviton-cache-v271';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=271',
  './assets/js/main.js?v=271',
  './assets/js/ui.js?v=271',
  './assets/js/db.js?v=271',
  './assets/js/utils.js?v=271',
  './assets/js/supabase-client.js?v=271',
