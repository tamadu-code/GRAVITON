const CACHE_NAME = 'graviton-cache-v169';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=169',
  './assets/js/main.js?v=169',
  './assets/js/ui.js?v=169',
  './assets/js/db.js?v=169',
  './assets/js/utils.js?v=169',
  './assets/js/supabase-client.js?v=169',
