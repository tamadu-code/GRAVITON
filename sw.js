const CACHE_NAME = 'graviton-cache-v290';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=286',
  './assets/js/main.js?v=286',
  './assets/js/ui.js?v=286',
  './assets/js/db.js?v=286',
  './assets/js/utils.js?v=286',
  './assets/js/supabase-client.js?v=286',
