const CACHE_NAME = 'graviton-cache-v230';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=230',
  './assets/js/main.js?v=230',
  './assets/js/ui.js?v=230',
  './assets/js/db.js?v=230',
  './assets/js/utils.js?v=230',
  './assets/js/supabase-client.js?v=230',
