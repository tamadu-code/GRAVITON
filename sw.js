const CACHE_NAME = 'graviton-cache-v266';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=266',
  './assets/js/main.js?v=266',
  './assets/js/ui.js?v=266',
  './assets/js/db.js?v=266',
  './assets/js/utils.js?v=266',
  './assets/js/supabase-client.js?v=266',
