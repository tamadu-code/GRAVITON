const CACHE_NAME = 'graviton-cache-v166';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=166',
  './assets/js/main.js?v=166',
  './assets/js/ui.js?v=166',
  './assets/js/db.js?v=166',
  './assets/js/utils.js?v=166',
  './assets/js/supabase-client.js?v=166',
