const CACHE_NAME = 'graviton-cache-v317';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './manifest.json',
  './assets/css/style.css?v=316',
  './assets/js/main.js?v=316',
  './assets/js/ui.js?v=316',
  './assets/js/db.js?v=316',
  './assets/js/utils.js?v=316',
  './assets/js/supabase-client.js?v=316',
